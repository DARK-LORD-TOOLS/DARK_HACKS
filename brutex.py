...
\033[1;91m<═══\033[1;41m\033[1;97m Created by DARK_LORD \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by DARK_LORD
\033[1;92m""")
...
# main script start
os.system("xdg-open https://www.youtube.com/@DARK_HACKS")
time.sleep(5)
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://instagram.com/xanonymousx_rnw?igshid=OGQ2MjdiOTE=")
				...
				time.sleep(1)
				os.system("xdg-open https://github.com/DARK-LORD-TOOLS")
				...
				time.sleep(1)
				os.system("xdg-open https://t.me/DARK_LORD_HACKS")
