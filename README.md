...
## Single line command:
```
apt update && apt upgrade && apt install git -y && git clone https://github.com/DARK-LORD-TOOLS/DARK_HACKS && cd BruteX && chmod +x * && bash setup.sh && python brutex.py
```
